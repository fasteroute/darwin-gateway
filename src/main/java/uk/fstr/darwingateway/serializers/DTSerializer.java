...
import uk.fstr.darwingateway.bindings.DT;

import java.lang.reflect.Type;

/** JSON Serializer for Push Port Schedule message Destinations created from the XML bindings.
 *
 * @author George Goldberg <george@fasteroute.com>
 */
public class DTSerializer implements JsonSerializer<DT> {

    @Override
    public JsonElement serialize(DT src, Type typeOfSrc, JsonSerializationContext context) {
        JsonObject object = new JsonObject();

        object.addProperty("location_type", "DT");
